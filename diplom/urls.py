...
urlpatterns = [
     ...
     path('user/<int:pk>', UsersRetrieveView.as_view()),
     path('user/<str:login>', UserLoginDetailView.as_view()),
     ...
     path('consultation/lecturer/list/<int:lecturerID>/<int:groupID>', ConsultationLecturerGroupListView.as_view()),
